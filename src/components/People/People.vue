<template>
  <div class="">
    ...
    <h6 class="text-base mt-4">People</h6>
    ...
    <form class="flex items-center mt-4">   
        <div class="relative w-full">
            ...
            <input type="text" id="simple-search" class="bg-dark-200 text-gray-200 text-sm rounded-lg focus:bg-dark-300 outline-0 block w-full ps-10 p-2.5  " placeholder="Search user.." required>
        </div>
